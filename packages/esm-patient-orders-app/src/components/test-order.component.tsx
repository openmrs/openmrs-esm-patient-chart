...
const TestOrder: React.FC<TestOrderProps> = ({ testOrder }) => {
  ...
  const tableHeaders = useMemo(() => {
    ...
    return [
      ...
      {
        key: 'normalRange',
        header: hasReferenceRanges ? t('referenceRange', 'Reference range') : t('normalRange', 'Normal range'),
      },
    ];
  }, [t, testOrder?.orderType?.display, referenceRanges]);
