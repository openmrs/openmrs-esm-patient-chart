...
export const configSchema = {
  ...
  labTestsWithOrderReasons: {
    ...
    _elements: {
      labTestUuid: {
        _type: Type.UUID,
        _description: 'UUID of the lab test for which coded order reasons should be offered',
        _default: '',
      },
      orderReasons: {
        _type: Type.Array,
        _elements: {
          ...
          _description: 'Array of coded concepts to show as order reasons for the lab test',
        },
        _default: [],
        _description: 'Selectable coded order reason concepts for the lab test',
      },
    },
    _default: [],
    _description:
      'Configures lab tests that support coded order reasons. When a test appears in this list, the form shows a dropdown with the provided concepts for that test type.',
  },
};
