 ...
 */
const ExportedVisitNotesForm: React.FC<Workspace2DefinitionProps<VisitNotesFormProps, {}, {}>> = ({
  closeWorkspace,
  workspaceProps: { formContext, encounter, patientUuid, patient, visitContext },
}) => {
...
export default ExportedVisitNotesForm;
