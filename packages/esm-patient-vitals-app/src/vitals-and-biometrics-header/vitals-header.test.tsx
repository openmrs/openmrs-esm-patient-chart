...
describe('VitalsHeader', () => {
  ...
  // Throwaway: the shared Trans mock (react-i18next.js:48) ignores i18nKey and plural
  // resolution, so component-level assertions only verify fallback children. This test
  // exercises real i18next against the actual translation JSON to prove the _one/_other
  // keys resolve correctly for both hours and days.
