...
describe('<VitalsOverview />', () => {
  it("renders an overview of the patient's vitals", async () => {
    ...
    expect(screen.getByRole('columnheader', { name: /bp \(mmhg\)/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /rate/i })).toBeInTheDocument();
    expect(screen.getByRole('columnheader', { name: /pulse \(beats\/min\)/i })).toBeInTheDocument();
  ...
  it('renders an empty state view when vitals data is absent', async () => {
    ...
    expect(screen.queryByRole('heading', { name: 'Vitals' })).toBeInTheDocument();
