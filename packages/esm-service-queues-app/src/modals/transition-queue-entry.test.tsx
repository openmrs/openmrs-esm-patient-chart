...
describe('TransitionQueueEntryModal', () => {
  ...
  it('shows a loading skeleton while fetching fresh queue entry data', () => {
    ...
    renderWithSwr(<TransitionQueueEntryModal queueEntry={mockQueueEntryAlice} closeModal={closeModal} />);

    expect(screen.getByTestId('transition-queue-entry-loading-skeleton')).toBeInTheDocument();
  });
