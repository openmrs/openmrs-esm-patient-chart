...
describe('<AppointmentsForm />', () => {
  ...
  it('renders the appointments form with all the relevant fields and values', async () => {
    ...
    mockGetAppointmentServiceAll.mockReturnValue(Promise.resolve(mockAppointmentsServiceFullResponse));
    mockGetAppointmentService.mockReturnValue(Promise.resolve(mockAppointmentsServiceResponse));
    mockCreateAppointment.mockReturnValue(Promise.resolve({ status: 200, statusText: 'ok' }));
