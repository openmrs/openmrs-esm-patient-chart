...
describe('<AppointmentRecord />', () => {
  const match = {
    ...
    isExact: true,
    url: '/',
    path: '/patient/64cb4894-848a-4027-8174-05c52989c0ca/chart/appointments/details/:appointmentUuid',
  };
  ...
  it('should display a detailed summary of the selected appointment record', async () => {
    mockGetAppointmentsByUuid.mockReturnValue(Promise.resolve(mockAppointmentResponse));
