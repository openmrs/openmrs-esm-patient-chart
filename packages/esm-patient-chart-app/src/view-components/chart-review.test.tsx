...
import { getExtensionInternalStore, useAssignedExtensions, useExtensionSlotMeta } from '@openmrs/esm-framework';
...
const mockGetExtensionInternalStore = getExtensionInternalStore as jest.Mock;
...
describe('ChartReview: ', () => {
  ...
  test(`renders a tabs-based layout if the provided config's layout type value is 'tabs'`, () => {
    ...
    mockGetExtensionInternalStore.mockReturnValue({
      getState() {
        return {
          extensions: {
